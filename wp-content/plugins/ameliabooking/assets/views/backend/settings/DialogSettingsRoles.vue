      ...
      <el-form :model="settings" ref="settings" :rules="rules" label-position="top" @submit.prevent="onSubmit">
        <el-tabs v-model="rolesTab">
          ...
          <el-tab-pane :label="$root.labels.employee" name="employee">
            ...
            <el-form-item v-show="settings.providerCabinet.enabled" prop="providerCabinet.pageUrl" :class="{'am-lite-disabled': ($root.isLite)}">
              <label slot="label">
              ...
              <el-input v-model="settings.providerCabinet.pageUrl" auto-complete="off" :disabled=$root.isLite />
            </el-form-item>
            <!-- Customer Cabinet URL -->
          ...
          <el-tab-pane :label="$root.labels.customer" name="customer">
            ...
            <!-- Customer Cabinet URL -->
            <el-form-item v-show="settings.customerCabinet.enabled" prop="customerCabinet.pageUrl">
              <label slot="label">
      ...
      return {
        ...
        rules: {
          'customerCabinet.pageUrl': [
            {validator: validateCustomerCabinetURL, trigger: 'submit'}
          ],
          'providerCabinet.pageUrl': [
            {validator: validateEmployeeCabinetURL, trigger: 'submit'}
          ]
        },
