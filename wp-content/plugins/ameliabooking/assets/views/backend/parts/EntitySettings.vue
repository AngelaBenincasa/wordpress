  ...
  <div class="am-entity-settings"  :class="{'am-lite-container-disabled': $root.isLite, 'am-entity-settings': true}">
    <el-collapse v-model="generalSettingsCollapse" v-if="generalSettings !== null">
      <el-collapse-item class="am-setting-box" name="generalSettings">
        <template slot="title">
          <img :src="$root.getUrl + 'public/img/setting.svg'" class="svg" style="margin-right: 10px;"/> {{ $root.labels.general }}
        </template>
    ...
    <el-collapse v-model="paymentsSettingsCollapse" v-if="paymentsSettings !== null">
      <el-collapse-item class="am-setting-box" name="paymentsSettings">
        <!-- Title -->
        <template slot="title">
          <img :src="$root.getUrl+'public/img/credit-card.svg'" class="svg" style="margin-right: 10px;"/> {{ $root.labels.payments }}
        </template>
        ...
        <div class="am-setting-box am-switch-box" v-if="$root.settings.payments.payPal.enabled">
          <el-row type="flex" align="middle" :gutter="24">
            <el-col :span="16">
              <img class="svg" width="60px" :src="$root.getUrl + 'public/img/payments/paypal-light.svg'">
            </el-col>
            <el-col :span="8" class="align-right">
              <el-switch
        ...
        <div class="am-setting-box am-switch-box" v-if="$root.settings.payments.stripe.enabled">
          <el-row type="flex" align="middle" :gutter="24">
            <el-col :span="16">
              <img class="svg" width="40px" :src="$root.getUrl + 'public/img/payments/stripe.svg'">
            </el-col>
            <el-col :span="8" class="align-right">
              <el-switch
    ...
    <el-collapse v-model="integrationsSettingsCollapse" v-if="zoomSettings">
      <el-collapse-item class="am-setting-box" name="integrationsSettings">
        <!-- Title -->
        <template slot="title">
          <img :src="$root.getUrl+'public/img/web-hook.svg'" class="svg" style="margin-right: 10px;"/> {{ $root.labels.integrations_settings }}
        </template>
