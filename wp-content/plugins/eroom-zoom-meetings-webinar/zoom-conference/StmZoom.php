...
class StmZoom
{
	...
	public static function stm_zoom_get_users_list( $options = [] ) {
	...
	public static function stm_zoom_get_users() {
		...
		if ( empty( $users ) ) {
			$users_list = self::stm_zoom_get_users_list( [ 'page_size' => 300 ] );
	 ...
	 * @return array
	 */
	public static function stm_zoom_get_users_pagination( int $page_number = 1 ) {
		$options = [
			'page_size' => 10,
